...
// Validate ../../src/app/(dashboard)/dsa-tracker/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/dsa-tracker">> = Specific
  const handler = {} as typeof import("../../src/app/(dashboard)/dsa-tracker/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
